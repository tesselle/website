...
Most of the R packages of the *tesselle* project are distributed on [CRAN](https://cran.r-project.org/) when they reach an acceptable level of maturity. Development versions can be installed from [GitHub](https://github.com/tesselle) using [remotes](https://remotes.r-lib.org) :
...
Thanks to the [R-universe](https://ropensci.org/r-universe/) project powered by [rOpenSci](https://ropensci.org), *tesselle* now has its own CRAN-like repository: [**tesselle.r-universe.dev**](https://tesselle.r-universe.dev). This repository allows to install all development versions and non-CRAN packages (e.g. [<abbr title="work-in-progress">WIP</abbr>](https://www.repostatus.org/#wip) packages and large data packages).
