...
<div class="event">
  ...
  <div class="eventDetails">All packages are distributed under a free license, publicly maintained, with source code accessible and versioned. You have the freedom to inspect the code and study how it works.</div>
</div>

<div class="event">
  <div class="eventTitle">[Reliability]{.tagline}</div>
  <div class="eventDetails">All packages undergo rigorous testing and code coverage. Dependencies are kept to a bare minimum. Your workflow will not break unexpectedly or without warning.</div>
</div>
:::
