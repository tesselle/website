...
title: "Coding Style"
description: |
  This section describes the coding style used throughout the **tesselle** project.
---
...
Always avoid package dependencies when possible (see [tinyverse.org](https://www.tinyverse.org/)).
...
Function and object descriptions should adhere to [roxygen2](https://roxygen2.r-lib.org/) guidelines.
...
This coding style is derived from the [tidyverse style guide](https://style.tidyverse.org), the [rOpenSci Packages book](https://devguide.ropensci.org) and Iegor Rudnytskyi's [R Coding Style Guide](https://irudnyts.github.io/r-coding-style-guide/).
